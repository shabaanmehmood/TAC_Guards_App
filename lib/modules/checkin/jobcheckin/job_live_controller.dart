...
class JobLiveController extends GetxController {
  ...
  void _handleAutomaticCompletion() {
    ...
    print("🚀 Auto-navigating to JobCompleteScreen");
  ...
  // Handle manual shift closure with three scenarios
  Future<void> handleManualShiftClosure() async {
    ...
    try {
      ...
      if (isEarlyClosure) {
        ...
        print("✅ Normal closure detected! Navigating to success screen");
  ...
  // Method to handle early closure from bottom sheet
